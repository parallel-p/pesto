...
class TestEjudgeParser(unittest.TestCase):
    ...
    def test_good(self):
        ...
        self.assertEqual(len(self.visitor.submits), 8)
    ...
    def test_bad_xml(self):
        ...
        self.assertEqual(len(self.visitor.submits), 7)
    ...
    def test_empty_folders(self):
        ...
        self.assertEqual(len(self.visitor.submits), 6)
    ...
    def test_run_number(self):
        do_parse('digit_zeros', '0010', self.visitor)
        self.assertEqual(self.visitor.submits[0].runs[0].case_id, 1)

    def test_not_all_in_csv(self):
        do_parse('not_all_in_csv', '001', self.visitor)
        self.assertEqual(len(self.visitor.submits), 4)
    ...
    def test_double_contest(self):
        ...
        self.assertEqual(len(self.visitor.submits), 15)
