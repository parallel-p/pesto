...
class SubmitsByRunsTest(unittest.TestCase):
    def test_eq_good(self):
        submits = []
        for i in range(5):
            submits.append(Submit(i, (i, i), i, 0, [Run( 0, 0, 0, '100', '100', 0)] * 1, 'OK', 'ACM', 37))
        submits.append(Submit(i, (i, i), i, 0, [Run(0, 0, 0, '100', '100', 0)] * 2, 'OK', 'ACM', 37))
    ...
    def test_gt_good(self):
        submits = []
        for i in range(5):
            submits.append(Submit(i, (i, i), i, 0, [Run( 0, 0, 0, '100', '100', 0)] * i, 'OK', 'ACM', 37))
