...
class SubmitsByRunsTest(unittest.TestCase):
    def test_eq_good(self):
        submits = []
        for i in range(5):
            submits.append(Submit(i, (i, i), i, 0, [Run( 0, 0, 0, 0)] * 1, 'OK', 'ACM'))
        submits.append(Submit(i, (i, i), i, 0, [Run(0, 0, 0, 0)] * 2, 'OK', 'ACM'))
    ...
    def test_gt_good(self):
        submits = []
        for i in range(5):
            submits.append(Submit(i, (i, i), i, 0, [Run( 0, 0, 0, 0)] * i, 'OK', 'ACM'))
