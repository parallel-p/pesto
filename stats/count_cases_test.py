...
class TestCountCases(unittest.TestCase):
    ...
    def test_common(self):
        self.counter.visit(Submit('1', (1, '1'), '0', [Run('1', '1', '-', 'OK', '0')] * 10, 'OK'))
        self.counter.visit(Submit('2', (1, '2'), '0', [Run('2', '2', '-', 'OK', '0')] * 20, 'OK'))
        self.counter.visit(Submit('3', (1, '3'), '0', [Run('3', '3', '-', 'OK', '0')] * 50, 'OK'))
        self.counter.visit(Submit('4', (1, '2'), '0', [Run('3', '4', '-', 'OK', '0')] * 30, 'OK'))
